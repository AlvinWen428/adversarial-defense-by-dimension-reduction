...
attack_img_save_dir = os.path.join(args.img_save_dir, 'baseline_pixels_{}_iteration_{}'.format(args.pixels, args.maxiter))
...
#     assert os.path.isdir('checkpoint'), 'Error: no checkpoint directory found!'
    ...
    net = vgg_tiny.vgg_tiny_complete()
    ...
    with open("./results/baseline_result.txt","a",encoding="utf-8") as f:
        result_str = "Model:Baseline  Pixels: {}  Iteration: {}  Final accuracy: {:.4f}\n".format(args.pixels, args.maxiter, 1-results)
        f.write(result_str)
